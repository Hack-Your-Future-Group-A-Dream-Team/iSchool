    ...
    return (
        <div className="add-school">
            ...
            <Form className="d-flex flex-column justify-content-around" onSubmit={handleSubmit}>
                ...
                <Form.Group as={Row} className="d-flex justify-content-center" controlId="name">
                    <Col sm="4">
                        <Label label="School Name" />
                    </Col>
                    <Col sm="8">
                        <Input type="text" name="name" value={school.name} onChange={onInputChange} />
                    </Col>
                </Form.Group>{" "}
                <Form.Group as={Row} className="d-flex justify-content-center" controlId="address">
                    <Col sm="12" className="d-flex justify-content-left">
                        <Label label="School Address:" />
                    </Col>
                </Form.Group>{" "}
                <Form.Group as={Row} className="d-flex justify-content-center" controlId="street">
                    <Col sm="4">
                        <Label label="Street" />
                    </Col>
                    <Col sm="8">
                        <Input type="text" name="street" value={school.address.street} onChange={onAddressChange} />
                    </Col>
                </Form.Group>{" "}
                ...
                <Form.Group as={Row} className="d-flex justify-content-center" controlId="city">
                    <Col sm="4">
                        <Label label="City" />
                    </Col>
                    <Col sm="8">
                        <Input type="text" name="city" value={school.address.city} onChange={onAddressChange} />
                    </Col>
                </Form.Group>{" "}
                <Form.Group as={Row} className="d-flex justify-content-center" controlId="email">
                    <Col sm="4">
                        <Label label="Email" />
                    </Col>
                    <Col sm="8">
                        <Input type="email" name="email" value={school.email} onChange={onInputChange} />
                    </Col>
                </Form.Group>{" "}
                <Form.Group as={Row} className="d-flex justify-content-center" controlId="phone">
                    <Col sm="4">
                        <Label label="Phone" />
                    </Col>
                    <Col sm="8">
                        <Input type="text" name="phone" value={school.phone} onChange={onInputChange} />
                    </Col>
                </Form.Group>{" "}
                <Form.Group as={Row} className="d-flex justify-content-center" controlId="website">
                    <Col sm="4">
                        <Label label="Web Site" />
                    </Col>
                    <Col sm="8">
                        <Input type="text" name="website" value={school.website} onChange={onInputChange} />
                    </Col>
                </Form.Group>{" "}
                <Form.Group as={Row} className="d-flex justify-content-center" controlId="description">
                    <Col sm="4">
                        <Label label="School Description" />
                    </Col>
                    <Col sm="8">
                        <Input type="text" name="description" value={school.description} onChange={onInputChange} />
                    </Col>
                </Form.Group>{" "}
                <Form.Group as={Row} className="d-flex justify-content-center" controlId="network">
                    <Col sm="4">
                        <Label label="School Network" />
                    </Col>
                    <Col sm="8">
                        <Select onChange={onNetworkChange} options={networkOptions} styles={selectStyles} />
                    </Col>
                </Form.Group>
                <Form.Group as={Row} className="d-flex justify-content-center" controlId="languageClasses">
                    ...
                    <Col sm="8">
                        <Select onChange={onFieldsChange} options={fieldsOptions} isMulti={true} styles={selectStyles} />
                    </Col>
                </Form.Group>
                <Form.Group as={Row} className="d-flex justify-content-center" controlId="languageClasses">
                    <Col  xs="4">
