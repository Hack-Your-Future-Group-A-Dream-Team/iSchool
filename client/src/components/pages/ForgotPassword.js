    ...
    return(
        <div style={{display: 'flex',  justifyContent:'center', alignItems:'center', margin:"60px auto", width: '70%', minHeight: "77vh"}} className="shadow p-3 mb-5 bg-white rounded main-container">
            ...
            <Form.Group as={Row} controlId="email">
                ...
                <Button style={{background: '#000051', border: "3px solid #000051", borderRadius:"10px", fontSize: "1.1rem", padding: "8px 35px", margin:"10px", width:"180px", fontWeight:"bold"}} className='hovered-blue' type="submit" size="lg">
                Submit
                </Button>
                </Col>
                </Form.Group>
